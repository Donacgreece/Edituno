...
if (!css.includes('content:"\\2194\\FE0E"') || !css.includes('content:"\\2195\\FE0E"')) {
  throw new Error('Cross-platform text-presentation transform arrows are missing')
}
...
if (!js.includes("offline-chunked-mediabunny")) {
  throw new Error('Offline chunked export result marker is missing')
}
...
console.log(`Built Edituno v0.9.6 -> ${dist}`)
